...
public class AgregarAlumnosMateria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        AgregarLista.setForeground(null);
        ...
        ListasCreadas.setForeground(null);
    ...
    private void txtCodigoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoKeyTyped
        ...
        if (Character.isLetter(validar)) {
            evt.consume();
            labelcodigo.setText("Solo numeros");
        }
        if (evt.getKeyChar() >= 32 && evt.getKeyChar() <= 32) {
            evt.consume();
            labelcodigo.setText("Sin espacios");
        } else {
            labelcodigo.setText("");
        }
